...
function actualizar() {
    ...
    let count = 0;
    for (let i = lista.firstIterator(); i != null; i = i.siguiente) {
        let cancion = i.info;
    ...
    if (lista.isEmpty()) {
        ...
        if (nodoCancionActual != null) {
            ...
            btnAnterior.disabled = nodoCancionActual.anterior == null;
        }
...
btnAnterior.onclick = () => {
    if (nodoCancionActual.anterior != null) {
